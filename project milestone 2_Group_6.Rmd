...
Yes we might convert sex to factor (numeric;1,2) using as.factor depending on the type of analysis we may be asked to run otherwise we could still leave sex as character variable (female,male).

#Provide a basic description of the 5+ data elements
#Numeric: mean, median, range`{r}
```{r}
